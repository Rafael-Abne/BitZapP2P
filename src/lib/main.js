    ...
    return {
        ...
        messages: {
            inbox: {
                ...
                listInboxMessagesIds: function (cb) {
                    callMethod({method: 'getAllInboxMessageIDs' }, function (value) {
                        var messages = value.inboxMessageIds;
                        cb(messages);
                    });
                },
            ...
            sent: {
                ...
                getSentMessagesBySender: function (fromAddress, cb) {
                    callMethod({
                        method: 'getSentMessagesBySender',
                        args: [fromAddress]
                    }, function (value) {
                        var messages = value;
                        cb(messages);
